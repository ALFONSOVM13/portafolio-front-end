        ...
        <>
            <section className={`${styles.section}`} id={'skills'} ref={container}>
                ...
                <div className={styles.grid}>
                    <Title color={'white'}><span>Mis</span> <br/> Skills</Title>
                    <div className={styles.circularCarouselWrapper}>
                        ...
                        <div className={styles.dragMe}>
                            <img src="/icon/dragme.svg" alt="drag" />
                        </div>
                    </div>
                </div>
            ...
            <Ticker words={['accesibilidad', 'responsividad', 'interactividad', 'rendimiento']}></Ticker>
        </>
    )
}